...
export const PROJECT_PROVISIONING_STATUS = {
  AWAITING_DEVOPS_SETUP: "AWAITING_DEVOPS_SETUP",
  DEVOPS_IN_PROGRESS: "DEVOPS_IN_PROGRESS",
  DEVOPS_READY: "DEVOPS_READY",
  DEVOPS_BLOCKED: "DEVOPS_BLOCKED",
  READY_FOR_DEVOPS_RETRY: "READY_FOR_DEVOPS_RETRY",
} as const;

export const PROJECT_PROVISIONING_STATUS_VALUES = Object.values(
...
export type ProjectProvisioningStatus =
  (typeof PROJECT_PROVISIONING_STATUS)[keyof typeof PROJECT_PROVISIONING_STATUS];
