...
const en = {
  ...
  "projectViews.pentest.tableTitle": "Pentester Projects",
  "projectViews.security.tableTitle": "Security Technical Manager Projects",
  "projectViews.quality.tableTitle": "Quality Technical Manager Projects",
  ...
  "projectTable.status.new": "New",
  "projectTable.status.inProgress": "In Progress",
  "projectTable.status.pended": "Pended",
  ...
  "projectTable.assignment.new": "New",
  "projectTable.assignment.pending": "Pending",
  "projectTable.assignment.completed": "Completed",
  ...
  "projectTable.columns.securityBugs": "Project bugs",
  "projectTable.columns.qaUsers": "QA Users",
  ...
  "projectTable.viewBugs": "Project bugs",
  ...
  "bugReview.sections.affectedUser": "Affected user",
  ...
  "pentestWorkspace.status.finish": "Finish",
  ...
  "pentestWorkspace.status.reopenProject": "Reopen project",
  ...
  "pentestWorkspace.findings.hasCve": "This finding has a CVE",
  "pentestWorkspace.findings.cvssRequiredHint":
    "Calculate the CVSS score before submitting this finding.",
  "pentestWorkspace.findings.httpMethod": "HTTP Method",
  "pentestWorkspace.findings.path": "Path",
  "pentestWorkspace.findings.affectedPaths": "Affected Paths",
  "pentestWorkspace.affectedPaths.description":
    "Manage every application path or endpoint affected by this finding.",
  "pentestWorkspace.affectedPaths.addPrompt": "Add affected path",
  "pentestWorkspace.affectedPaths.count": "{count} Affected Paths",
  "pentestWorkspace.affectedPaths.empty": "No affected paths have been added.",
  "pentestWorkspace.affectedPaths.add": "+ Add Path",
  "pentestWorkspace.affectedPaths.newPath": "New path",
  "pentestWorkspace.affectedPaths.editPath": "Edit path",
  "pentestWorkspace.affectedPaths.edit": "Edit",
  "pentestWorkspace.affectedPaths.remove": "Remove",
  "pentestWorkspace.affectedPaths.cancel": "Cancel",
  "pentestWorkspace.affectedPaths.save": "Save",
  "pentestWorkspace.affectedPaths.done": "Done",
  "pentestWorkspace.affectedPaths.required": "Enter a path before saving.",
  "pentestWorkspace.affectedPaths.duplicate": "This path has already been added.",
  "pentestWorkspace.findings.parameter": "Parameter",
  "pentestWorkspace.findings.affectedUsername": "Affected Username",
  "pentestWorkspace.findings.affectedUsernamePlaceholder":
    "Username where the issue occurred (optional)",
  "pentestWorkspace.findings.affectedUserRole": "Affected User Role",
  "pentestWorkspace.findings.affectedUserRolePlaceholder":
    "Admin, User, Manager… (optional)",
  "pentestWorkspace.requestHeaders.title": "Request Headers",
  "pentestWorkspace.requestHeaders.description":
    "Paste headers exactly as sent, upload a text file, or use both methods.",
  "pentestWorkspace.requestHeaders.manual": "Manual headers",
  "pentestWorkspace.requestHeaders.manualPlaceholder":
    "Authorization: Bearer ...\nContent-Type: application/json\nX-Request-ID: ...",
  "pentestWorkspace.requestHeaders.upload": "Upload headers file",
  "pentestWorkspace.requestHeaders.fileHint": "Plain-text .txt files up to 1 MB.",
  "pentestWorkspace.requestHeaders.chooseFile": "Choose .txt file",
  "pentestWorkspace.requestHeaders.replaceFile": "Replace file",
  "pentestWorkspace.requestHeaders.removeFile": "Remove file",
  "pentestWorkspace.requestHeaders.invalidFileType":
    "Choose a plain-text file with a .txt extension.",
  "pentestWorkspace.requestHeaders.fileTooLarge":
    "The headers file must be 1 MB or smaller.",
  "pentestWorkspace.requestHeaders.viewFile": "View file",
  "pentestWorkspace.requestHeaders.downloadFile": "Download",
  ...
  "pentestWorkspace.session.reopenSuccess": "Project reopened and work timer started.",
...
const fa: Record<TranslationKey, string> = {
  ...
  "projectViews.pentest.tableTitle": "پروژه‌های تست‌کننده نفوذ",
  "projectViews.security.tableTitle": "پروژه‌های مدیر فنی امنیت",
  "projectViews.quality.tableTitle": "پروژه‌های مدیر فنی کیفیت",
  ...
  "projectTable.status.new": "جدید",
  "projectTable.status.inProgress": "در حال انجام",
  "projectTable.status.pended": "متوقف‌شده",
  ...
  "projectTable.assignment.new": "جدید",
  "projectTable.assignment.pending": "در انتظار",
  "projectTable.assignment.completed": "تکمیل شده",
  ...
  "projectTable.columns.securityBugs": "باگ‌های پروژه",
  "projectTable.columns.qaUsers": "کاربران تضمین کیفیت",
  ...
  "projectTable.viewBugs": "باگ‌های پروژه",
  ...
  "bugReview.sections.affectedUser": "کاربر تحت تأثیر",
  ...
  "pentestWorkspace.status.finish": "پایان",
  ...
  "pentestWorkspace.status.reopenProject": "بازگشایی پروژه",
  ...
  "pentestWorkspace.findings.hasCve": "این یافته دارای CVE است",
  "pentestWorkspace.findings.cvssRequiredHint":
    "پیش از ارسال این یافته، امتیاز CVSS را محاسبه کنید.",
  "pentestWorkspace.findings.httpMethod": "متد HTTP",
  "pentestWorkspace.findings.path": "مسیر",
  "pentestWorkspace.findings.affectedPaths": "مسیرهای تحت تأثیر",
  "pentestWorkspace.affectedPaths.description":
    "تمام مسیرها یا endpointهای برنامه که تحت تأثیر این یافته هستند را مدیریت کنید.",
  "pentestWorkspace.affectedPaths.addPrompt": "افزودن مسیر تحت تأثیر",
  "pentestWorkspace.affectedPaths.count": "{count} مسیر تحت تأثیر",
  "pentestWorkspace.affectedPaths.empty": "هنوز مسیر تحت تأثیری اضافه نشده است.",
  "pentestWorkspace.affectedPaths.add": "+ افزودن مسیر",
  "pentestWorkspace.affectedPaths.newPath": "مسیر جدید",
  "pentestWorkspace.affectedPaths.editPath": "ویرایش مسیر",
  "pentestWorkspace.affectedPaths.edit": "ویرایش",
  "pentestWorkspace.affectedPaths.remove": "حذف",
  "pentestWorkspace.affectedPaths.cancel": "انصراف",
  "pentestWorkspace.affectedPaths.save": "ذخیره",
  "pentestWorkspace.affectedPaths.done": "انجام شد",
  "pentestWorkspace.affectedPaths.required": "پیش از ذخیره، مسیر را وارد کنید.",
  "pentestWorkspace.affectedPaths.duplicate": "این مسیر قبلاً اضافه شده است.",
  "pentestWorkspace.findings.parameter": "پارامتر",
  "pentestWorkspace.findings.affectedUsername": "نام کاربری تحت تأثیر",
  "pentestWorkspace.findings.affectedUsernamePlaceholder":
    "نام کاربری حسابی که مشکل در آن رخ داده است (اختیاری)",
  "pentestWorkspace.findings.affectedUserRole": "نقش کاربر تحت تأثیر",
  "pentestWorkspace.findings.affectedUserRolePlaceholder":
    "مدیر، کاربر، مدیر میانی و… (اختیاری)",
  "pentestWorkspace.requestHeaders.title": "هدرهای درخواست",
  "pentestWorkspace.requestHeaders.description":
    "هدرها را دقیقاً همان‌گونه که ارسال شده‌اند وارد کنید، فایل متنی بارگذاری کنید یا از هر دو روش استفاده کنید.",
  "pentestWorkspace.requestHeaders.manual": "هدرهای دستی",
  "pentestWorkspace.requestHeaders.manualPlaceholder":
    "Authorization: Bearer ...\nContent-Type: application/json\nX-Request-ID: ...",
  "pentestWorkspace.requestHeaders.upload": "بارگذاری فایل هدرها",
  "pentestWorkspace.requestHeaders.fileHint": "فایل متنی .txt با حداکثر حجم ۱ مگابایت.",
  "pentestWorkspace.requestHeaders.chooseFile": "انتخاب فایل .txt",
  "pentestWorkspace.requestHeaders.replaceFile": "جایگزینی فایل",
  "pentestWorkspace.requestHeaders.removeFile": "حذف فایل",
  "pentestWorkspace.requestHeaders.invalidFileType":
    "یک فایل متنی ساده با پسوند .txt انتخاب کنید.",
  "pentestWorkspace.requestHeaders.fileTooLarge":
    "حجم فایل هدرها باید حداکثر ۱ مگابایت باشد.",
  "pentestWorkspace.requestHeaders.viewFile": "مشاهده فایل",
  "pentestWorkspace.requestHeaders.downloadFile": "دانلود",
  ...
  "pentestWorkspace.session.reopenSuccess": "پروژه بازگشایی شد و زمان‌سنج کار آغاز شد.",
