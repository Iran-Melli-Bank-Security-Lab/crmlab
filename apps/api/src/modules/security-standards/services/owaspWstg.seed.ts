import type { SecurityStandard } from "../models/securityStandard.model";
import { upsertSecurityStandardCatalog } from "./securityStandard.service";

const WSTG_REFERENCE_URL = "https://owasp.org/www-project-web-security-testing-guide/";

export const OWASP_WSTG_WEB_SEED: SecurityStandard = {
  "standardKey": "owasp-wstg",
  "name": "OWASP Web Security Testing Guide",
  "shortName": "OWASP WSTG",
  "version": "4.2",
  "type": "web",
  "isActive": true,
  "nodes": [
    {
      ...
      "exploitFa": "",
      "solution": "",
      "referenceUrl": WSTG_REFERENCE_URL,
      "order": 0,
      "children": [
        {
          "nodeId": "4.1.1",
          ...
          "exploitFa": "استفاده از عملگرهای خاص سایت و کلمات کلیدی در موتورهای جستجو برای یافتن اطلاعات افشا شده",
        ...
        },
        {
          ...
          "exploitFa": "ارسال درخواست‌های HTTP و تحلیل هدرها و پاسخ‌ها برای شناسایی نوع و نسخه سرور",
        ...
        },
        {
          ...
          "exploitFa": "دسترسی به فایل‌های متا مانند robots.txt، sitemap.xml یا فایل‌های پشتیبان برای یافتن اطلاعات حساس",
        ...
        },
        {
          ...
          "exploitFa": "اسکن دایرکتوری‌های سرور و استفاده از ابزارهای انگشت‌نگاری برای لیست برنامه‌های نصب شده",
        ...
        },
        {
          ...
          "exploitFa": "بررسی کد منبع HTML، نظرات و فراداده‌ها برای یافتن اطلاعات حساس",
        ...
        },
        {
          ...
          "exploitFa": "تحلیل پارامترهای URL، فرم‌ها و نقاط پایانی برای شناسایی بردارهای ورودی احتمالی",
        ...
        },
        {
          ...
          "exploitFa": "ردیابی جریان درخواست‌ها و رفتارهای نشست برای درک منطق برنامه",
        ...
        },
        {
          ...
          "exploitFa": "تحلیل پاسخ‌های HTTP، کوکی‌ها و ساختار صفحه برای شناسایی نوع فریمورک",
        ...
        },
        {
          ...
          "exploitFa": "استفاده از ابزارهای انگشت‌نگاری و بررسی دستی برای شناسایی برنامه",
        ...
        },
        {
          ...
          "exploitFa": "تحلیل جریان صفحات، نقاط پایانی API و تعاملات برای درک معماری سیستم",
      ...
      "children": [
        {
          ...
          "exploitFa": "بررسی دستگاه‌های شبکه، قوانین فایروال و پیکربندی مسیریابی برای یافتن تنظیمات نادرست",
        ...
        },
        {
          ...
          "exploitFa": "بررسی تنظیمات پلتفرم، سرویس‌ها و ماژول‌ها برای یافتن تنظیمات پیش‌فرض یا ضعیف",
        ...
        },
        {
          ...
          "exploitFa": "تلاش برای دسترسی به فایل‌های حساس با پسوندهای رایج یا مدیریت‌کننده‌های نادرست",
        ...
        },
        {
          ...
          "exploitFa": "یافتن فایل‌های پشتیبان و بی‌مرجع و بررسی آن‌ها برای اطلاعات محرمانه",
        ...
        },
        {
          ...
          "exploitFa": "اسکن برای یافتن رابط‌های مدیریتی، داشبوردها و پنل‌های کنترل قابل دسترسی از طریق وب یا شبکه",
        ...
        },
        {
          ...
          "exploitFa": "ارسال درخواست‌ها با استفاده از روش‌های غیرمعمول HTTP برای تست رفتار سرور",
        ...
        },
        {
          ...
          "exploitFa": "بررسی هدرهای پاسخ برای اطمینان از فعال بودن و پیکربندی صحیح HSTS",
        ...
        },
        {
          ...
          "exploitFa": "بررسی فایل‌های سیاست بین دامنه‌ای و تنظیمات برای یافتن قوانین سهل‌انگارانه",
        ...
        },
        {
          ...
          "exploitFa": "بررسی مجوزهای سیستم فایل و دایرکتوری برای دسترسی ناامن",
        ...
        },
        {
          ...
          "exploitFa": "بررسی ورودی‌های DNS بدون مالک که به سرویس‌های خارج از سرویس اشاره می‌کنند",
        ...
        },
        {
          ...
          "exploitFa": "بررسی مجوزهای ذخیره‌سازی ابری، سطل‌ها و فایل‌های اشتراکی برای یافتن اطلاعات افشا شده",
        ...
        },
        {
          ...
          "exploitFa": "بررسی هدرها و متا تگ‌ها برای اعتبارسنجی اعمال صحیح قوانین CSP",
        ...
        },
        {
          ...
          "exploitFa": "تلاش برای حملات پیمایش مسیر و پیوندهای نمادین برای دسترسی به فایل‌های غیرمجاز",
      ...
      "children": [
        {
          ...
          "exploitFa": "تلاش برای انجام اقدامات فراتر از مجوزهای نقش اختصاص داده شده برای بررسی ارتقای امتیاز",
        ...
        },
        {
          ...
          "exploitFa": "ارسال ورودی‌های نامعتبر یا مخرب در طول ثبت‌نام برای تست اعتبارسنجی و ایجاد حساب",
        ...
        },
        {
          ...
          "exploitFa": "تلاش برای ایجاد حساب‌های با امتیازات غیرمجاز یا تست دور زدن گردش کار",
        ...
        },
        {
          ...
          "exploitFa": "تلاش برای برشماری نام کاربری از طریق پیام‌های خطای ورود یا حملات زمان‌بندی برای شناسایی حساب‌های معتبر",
        ...
        },
        {
          ...
          "exploitFa": "تلاش برای ثبت نام یا حدس زدن حساب‌ها با استفاده از نام‌های کاربری رایج یا قابل پیش‌بینی",
      ...
      "children": [
        {
          ...
          "exploitFa": "رصد اعتبارنامه‌ها در ارتباطات رمزگذاری نشده با استفاده از ابزارهای شنود شبکه",
        ...
        },
        {
          ...
          "exploitFa": "تلاش برای ورود با استفاده از نام کاربری و رمزعبورهای پیش‌فرض شناخته شده سیستم",
        ...
        },
        {
          ...
          "exploitFa": "تلاش مکرر برای ورود نامعتبر برای تست آستانه‌های مسدودسازی",
        ...
        },
        {
          ...
          "exploitFa": "تلاش برای تثبیت نشست، دستکاری پارامترها یا تزریق SQL برای دور زدن احراز هویت",
        ...
        },
        {
          ...
          "exploitFa": "بررسی حافظه محلی، کوکی‌ها یا حافظه مرورگر برای بازیابی رمزهای عبور ذخیره شده",
        ...
        },
        {
          ...
          "exploitFa": "دسترسی به صفحات یا منابع ذخیره شده در حافظه پنهان برای بازیابی داده‌های حساس پس از خروج",
        ...
        },
        {
          ...
          "exploitFa": "تلاش برای تنظیم رمزهای عبور ضعیف یا استفاده از brute-force برای تست اجرای سیاست قدرت رمزعبور",
        ...
        },
        {
          ...
          "exploitFa": "تلاش برای بازنشانی رمزعبور با استفاده از پاسخ‌های قابل حدس به سوالات امنیتی",
        ...
        },
        {
          ...
          "exploitFa": "تلاش برای بازنشانی یا تغییر رمزعبور غیرمجاز با دستکاری فرآیند",
        ...
        },
        {
          ...
          "exploitFa": "تلاش برای احراز هویت از طریق کانال‌های جایگزین با مکانیزم‌های تأیید ضعیف",
        ...
        },
        {
          ...
          "exploitFa": "تلاش برای دور زدن MFA با استفاده از مهندسی اجتماعی یا حملات تکرار",
      ...
      "children": [
        {
          ...
          "exploitFa": "تلاش برای حملات پیمایش دایرکتوری برای شامل کردن یا خواندن فایل‌های غیرمجاز",
        ...
        },
        {
          ...
          "exploitFa": "دستکاری پارامترها یا URLها برای دسترسی به منابع محدود شده بدون مجوز مناسب",
        ...
        },
        {
          ...
          "exploitFa": "سوءاستفاده از تنظیمات نادرست یا آسیب‌پذیری‌ها برای کسب امتیازات بالاتر",
        ...
        },
        {
          ...
          "exploitFa": "دسترسی به اشیاء با تغییر پارامترها برای ارجاع به منابع غیرمجاز",
          ...
          "children": [
            {
              ...
              "exploitFa": "تلاش برای دستکاری توکن، حملات تکرار یا محدوده‌های پیکربندی نادرست در سرور احراز هویت",
            ...
            },
            {
              ...
              "exploitFa": "بررسی ذخیره‌سازی سمت کلاینت یا رهگیری توکن‌ها برای دسترسی غیرمجاز",
      ...
      "children": [
        {
          ...
          "exploitFa": "تلاش برای دستکاری شناسه‌های نشست یا جریان نشست برای دسترسی غیرمجاز",
        ...
        },
        {
          ...
          "exploitFa": "بررسی و دستکاری کوکی‌ها برای سرقت یا ربودن اطلاعات نشست",
        ...
        },
        {
          ...
          "exploitFa": "تنظیم شناسه نشست از پیش تعریف شده و تلاش برای استفاده از آن به عنوان کاربر دیگر",
        ...
        },
        {
          ...
          "exploitFa": "دسترسی به متغیرهای نشست از طریق اسکریپت‌های سمت کلاینت یا دستکاری URL",
        ...
        },
        {
          ...
          "exploitFa": "جعل درخواست‌های مخرب از سایت دیگر برای انجام اقدامات به نام کاربر",
        ...
        },
        {
          ...
          "exploitFa": "تأیید باطل شدن نشست پس از خروج با استفاده مجدد از شناسه‌های نشست قدیمی",
        ...
        },
        {
          ...
          "exploitFa": "نگه داشتن نشست در حالت بی‌کاری و بررسی انقضای آن پس از مدت زمان تعریف شده",
        ...
        },
        {
          ...
          "exploitFa": "تلاش برای دستکاری‌های غیرمعمول نشست برای یافتن ناسازگاری‌ها یا آسیب‌پذیری‌ها",
        ...
        },
        {
          ...
          "exploitFa": "رهگیری یا سرقت توکن‌های نشست فعال برای دسترسی غیرمجاز",
        ...
        },
        {
          ...
          "exploitFa": "تلاش برای دستکاری محموله‌های JWT یا استفاده از توکن‌های منقضی شده برای دور زدن احراز هویت",
        ...
        },
        {
          ...
          "exploitFa": "ورود همزمان از چندین دستگاه و بررسی مدیریت صحیح نشست‌ها",
      ...
      "children": [
        {
          ...
          "exploitFa": "تزریق اسکریپت‌های مخرب در فیلدهای ورودی و مشاهده بازتاب آن در پاسخ",
        ...
        },
        {
          ...
          "exploitFa": "ارسال محموله‌ها به ذخیره‌سازی پایدار و فعال کردن آن‌ها هنگام بازیابی",
        ...
        },
        {
          ...
          "exploitFa": "تغییر روش‌های HTTP مانند تبدیل POST به GET برای دور زدن محدودیت‌ها",
        ...
        },
        {
          ...
          "exploitFa": "ارسال چندین پارامتر با نام یکسان برای بررسی اثرات آلودگی",
          ...
          "children": [
            {
              ...
              "exploitFa": "تزریق محموله‌های SQL در کوئری‌های اوراکل برای استخراج یا تغییر داده‌ها",
            ...
            },
            {
              ...
              "exploitFa": "تزریق محموله‌های SQL در کوئری‌های MySQL برای دستکاری عملیات پایگاه داده",
            ...
            },
            {
              ...
              "exploitFa": "تزریق محموله‌های SQL مختص SQL Server برای دور زدن کوئری‌ها یا استخراج داده",
            ...
            },
            {
              ...
              "exploitFa": "تزریق محموله‌های خاص PostgreSQL برای تست آسیب‌پذیری‌های تزریق SQL",
            ...
            },
            {
              ...
              "exploitFa": "تزریق محموله‌های SQL در کوئری‌های MS Access برای تأیید آسیب‌پذیری",
            ...
            },
            {
              ...
              "exploitFa": "تزریق محموله‌های مختص پایگاه‌های داده NoSQL برای دستکاری کوئری‌ها",
            ...
            },
            {
              ...
              "exploitFa": "تزریق محموله‌ها از طریق کوئری‌های ORM برای تست آسیب‌پذیری‌های تزریق",
            ...
            },
            {
              ...
              "exploitFa": "ارسال محموله‌های سمت کلاینت برای فعال کردن اجرای SQL در سرور",
        ...
        },
        {
          ...
          "exploitFa": "تزریق کوئری‌های LDAP برای دستکاری جستجوهای دایرکتوری یا احراز هویت",
        ...
        },
        {
          ...
          "exploitFa": "تزریق محموله‌های XML مخرب در تجزیه‌کننده‌های XML برنامه",
        ...
        },
        {
          ...
          "exploitFa": "درج دستورات SSI برای بررسی اجرا در سرور",
        ...
        },
        {
          ...
          "exploitFa": "تزریق محموله‌های XPath برای دستکاری نتایج کوئری‌های XML",
        ...
        },
        {
          ...
          "exploitFa": "ارسال دستورات ساختگی به سرورهای IMAP/SMTP برای تست تزریق",
          ...
          "children": [
            {
              ...
              "exploitFa": "تزریق دستورات سیستم یا اسکریپت‌ها برای اجرا در سرور",
            ...
            },
            {
              ...
              "exploitFa": "شامل کردن فایل‌های محلی یا راه دور برای فعال کردن اجرای ناخواسته",
        ...
        },
        {
          ...
          "exploitFa": "تزریق دستورات سیستم عامل در فیلدهای ورودی و مشاهده اجرا",
        ...
        },
        {
          ...
          "exploitFa": "استفاده از مشخص‌کننده‌های قالب در فیلدهای ورودی برای سوءاستفاده از آسیب‌پذیری",
        ...
        },
        {
          ...
          "exploitFa": "شناسایی آسیب‌پذیری‌های نهفته از طریق فازینگ یا تحلیل ایستا",
        ...
        },
        {
          ...
          "exploitFa": "دستکاری هدرهای HTTP برای تقسیم یا قاچاق درخواست‌ها",
        ...
        },
        {
          ...
          "exploitFa": "ارسال درخواست‌های HTTP ساختگی برای تست مدیریت درخواست‌ها",
        ...
        },
        {
          ...
          "exploitFa": "تغییر هدر Host و مشاهده پاسخ‌های سرور",
        ...
        },
        {
          ...
          "exploitFa": "تزریق عبارات قالب برای فعال کردن اجرای سمت سرور",
        ...
        },
        {
          ...
          "exploitFa": "ارسال درخواست‌ها از سرور به سرویس‌های داخلی برای تست SSRF",
        ...
        },
        {
          ...
          "exploitFa": "تلاش برای اختصاص فیلدهای حساس از طریق محموله‌های ورودی",
      ...
      "children": [
        {
          ...
          "exploitFa": "ایجاد خطا و مشاهده آیا پیام‌های خطای دقیق یا ردپای استک برگردانده می‌شود",
        ...
        },
        {
          ...
          "exploitFa": "ایجاد استثناهای برنامه و بررسی آیا ردپای استک به کاربران نمایش داده می‌شود",
      ...
      "children": [
        {
          ...
          "exploitFa": "تحلیل پیکربندی SSL/TLS برای یافتن رمزهای ضعیف یا نسخه‌های پروتکل و تلاش برای حملات مرد میانی",
        ...
        },
        {
          ...
          "exploitFa": "ارسال متن‌های رمزنگاری شده ساختگی و تحلیل پاسخ‌های سرور برای استنتاج متن اصلی با استفاده از حملات Padding Oracle",
        ...
        },
        {
          ...
          "exploitFa": "رصد ترافیک در کانال‌های غیررمزگذاری شده با استفاده از ابزارهای شنود شبکه برای ضبط داده‌های حساس",
        ...
        },
        {
          ...
          "exploitFa": "تحلیل داده‌های رمزنگاری شده و تلاش برای شکستن الگوریتم‌های ضعیف با استفاده از ابزارهای رمزنگاری",
      ...
      "children": [
        {
          ...
          "exploitFa": "ارسال داده‌های نادرست یا غیرمنتظره به توابع منطق کسب و کار و مشاهده رفتار برنامه",
        ...
        },
        {
          ...
          "exploitFa": "ساخت و ارسال درخواست‌های HTTP غیرمجاز برای دسترسی به عملکردهای محدود شده",
        ...
        },
        {
          ...
          "exploitFa": "دستکاری داده‌ها یا پارامترهای فرآیند برای دور زدن بررسی‌های یکپارچگی و مشاهده رفتار",
        ...
        },
        {
          ...
          "exploitFa": "ارسال درخواست‌های همزمان یا دستکاری زمان‌بندی برای شناسایی شرایط مسابقه",
        ...
        },
        {
          ...
          "exploitFa": "فراخوانی مکرر یک تابع برای تست اجرای محدودیت‌های استفاده",
        ...
        },
        {
          ...
          "exploitFa": "تلاش برای رد شدن یا دور زدن مراحل گردش کار و تأیید آیا اقدامات غیرمجاز موفق می‌شوند",
        ...
        },
        {
          ...
          "exploitFa": "تلاش برای اقداماتی که از ویژگی‌های برنامه سوءاستفاده می‌کنند و مشاهده کنترل‌های امنیتی",
        ...
        },
        {
          ...
          "exploitFa": "بارگذاری فایل‌هایی با انواع غیرپشتیبانی شده و مشاهده رفتار برنامه",
        ...
        },
        {
          ...
          "exploitFa": "بارگذاری فایل‌های حاوی بدافزار یا اسکریپت برای تست کنترل‌های امنیتی",
        ...
        },
        {
          ...
          "exploitFa": "تلاش برای دستکاری پارامترهای پرداخت یا تراکنش‌ها برای تست یکپارچگی سیستم",
      ...
      "children": [
        {
          ...
          "exploitFa": "تزریق اسکریپت‌های مخرب به ورودی‌های دستکاری شده DOM و مشاهده اجرا",
        ...
        },
        {
          ...
          "exploitFa": "تزریق یا دستکاری کد جاوااسکریپت برای تست اجرای سمت کلاینت",
        ...
        },
        {
          ...
          "exploitFa": "درج تگ‌های HTML در فیلدهای ورودی و مشاهده رفتار رندرینگ",
        ...
        },
        {
          ...
          "exploitFa": "دستکاری پارامترهای URL برای تغییر مسیر کاربران به مقاصد غیرمجاز",
        ...
        },
        {
          ...
          "exploitFa": "تزریق کد CSS در فیلدهای قابل کنترل کاربر و مشاهده تغییرات استایل",
        ...
        },
        {
          ...
          "exploitFa": "دستکاری منابع سمت کلاینت (JS، JSON و غیره) و بررسی رفتار",
        ...
        },
        {
          ...
          "exploitFa": "ارسال درخواست‌های cross-origin برای بررسی هدرهای CORS نادرست",
        ...
        },
        {
          ...
          "exploitFa": "تزریق یا دستکاری اشیاء Flash برای تست آسیب‌پذیری‌های CSF",
        ...
        },
        {
          ...
          "exploitFa": "روکش کردن عناصر UI برای فریب کاربر به انجام اقدامات ناخواسته",
        ...
        },
        {
          ...
          "exploitFa": "رهگیری یا دستکاری پیام‌های WebSocket برای تست امنیت",
        ...
        },
        {
          ...
          "exploitFa": "ارسال یا رهگیری پیام‌ها با استفاده از API postMessage برای تست رفتار",
        ...
        },
        {
          ...
          "exploitFa": "بررسی و دستکاری ورودی‌های ذخیره‌سازی مرورگر برای تست امنیت",
        ...
        },
        {
          ...
          "exploitFa": "تزریق اسکریپت‌های خارجی و مشاهده اجرا در context کلاینت",
        ...
        },
        {
          ...
          "exploitFa": "باز کردن تب‌های جدید با صفحات دستکاری شده برای تست reverse tabnabbing",
      ...
      "children": [
        {
          ...
          "exploitFa": "ارسال کوئری‌ها و mutationهای GraphQL ساختگی برای تست مجوزها، اعتبارسنجی ورودی و افشای داده",
...
export function seedOwaspWstgWebCatalog() {
  return upsertSecurityStandardCatalog(OWASP_WSTG_WEB_SEED);
}
