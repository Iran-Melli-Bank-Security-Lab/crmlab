...
const en = {
  ...
  "pentestWorkspace.findings.empty": "No findings submitted for this checklist item yet.",
...
const fa: Record<TranslationKey, string> = {
  ...
  "pentestWorkspace.findings.empty": "برای این آیتم چک‌لیست هنوز یافته‌ای ثبت نشده است.",
