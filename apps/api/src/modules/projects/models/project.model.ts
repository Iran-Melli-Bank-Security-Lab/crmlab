...
const deadlineExtensionRequestSchema = new Schema(
  {
    ...
    technicalReviewedBy: { type: Schema.Types.ObjectId, ref: "User" },
    technicalReviewedAt: { type: Date },
    technicalReviewNote: { type: String, trim: true, maxlength: 2000 },
    adminReviewedBy: { type: Schema.Types.ObjectId, ref: "User" },
    adminReviewedAt: { type: Date },
    adminReviewNote: { type: String, trim: true, maxlength: 2000 },
