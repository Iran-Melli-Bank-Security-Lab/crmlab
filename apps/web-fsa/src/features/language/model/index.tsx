...
const en = {
  ...
  "pentestWorkspace.attachments.title": "Image and video attachments",
  "pentestWorkspace.attachments.limits":
    "Up to {count} files · images {imageSize} · videos {videoSize} · {totalSize} total",
  ...
  "pentestWorkspace.attachments.formats":
    "JPG, JPEG, PNG, WEBP, GIF, MP4, WEBM, or MOV",
...
const fa: Record<TranslationKey, string> = {
  ...
  "pentestWorkspace.attachments.title": "پیوست‌های تصویری و ویدیویی",
  "pentestWorkspace.attachments.limits":
    "حداکثر {count} فایل · تصویر {imageSize} · ویدیو {videoSize} · مجموع {totalSize}",
  ...
  "pentestWorkspace.attachments.formats":
    "JPG، JPEG، PNG، WEBP، GIF، MP4، WEBM یا MOV",
